...
t10 = Tour(name="Swamp Tour", description="The swamps of Dagobah are home to some exotic creatures and plant life.  Take a tour of them on a swamp boat with an expert guide!", start_time='03:30 PM', end_time='05:30 PM', duration=2, planet_name="Dagobah")
...
t13 = Tour(name="Forest Speeder Tour", description="Ever wanted to hop on a speeder bike and whizz through the forests of Endor like Luke and Leia did?  Well, now's your chance!  Your tour guide will give you a few quick safety lessons, then you're off!  Zoom past the enormous trees of Endor and create a memory that will last forever!", start_time='11:00 AM', end_time='01:00 PM', duration=2, planet_name="Endor")
...
t23 = Tour(name="Speeder Tour", description="Take a tour of the land on a speeder similar to the one Count Dooku used to get away during the First Battle of Geonosis!  You can speed across the great sand dunes, plateaus, mountains, and spires.  Admire the red beauty of Geonosis today!", start_time='04:00 PM', end_time='06:00 PM', duration=2, planet_name="Geonosis")
t24 = Tour(name="Varactyl Tour", description="Tour the many levels of Pau City on the back of a varactyl!  Varactyls, even though they are big and loud, are gentle and loyal creatures.  Your native Utapauan tour guide will teach you everything you need to know about varactyls and will take you on a tour through all the levels of Pau City.  Masters of climbing, these creatures will take you anywhere you want to go.  Hold on tight and have fun!", start_time='03:00 PM', end_time='05:00 PM', duration=2, planet_name="Utapau")
t25 = Tour(name="Wheel Bike Tour", description="Prefer a mechanical vehicle over a biological one?  Then take an exhilarating ride on a TSMEU-6 Wheel Bike!  This was the preferred mode of transportation for Separatist General Grievous.  Take it for a ride through the countless levels of Pau City.  Like the varactyls, the wheel bike also is good at climbing and gripping.  Your Utapauan tour guide will teach you all the safety stuff and guide you through the city.  Book now!", start_time='12:00 PM', end_time='02:00 PM', duration=2, planet_name="Utapau")
...
t29 = Tour(name="Wookie Flying Catamaran Tour", description="The gentle and friendly wookies will take you on quite a ride with this tour!  Take a ride with your wookie tour guide on one of their famous flying catamarans and view their capital city of Kachirho from the air!  You'll soar over the beautiful coastal city and over the surrounding lush land.  It's an exhilarating, beautiful, and unforgettable ride!", start_time='12:00 PM', end_time='01:00 PM', duration=1, planet_name="Kashyyyk")
...
t34 = Tour(name="Aerial City Tour", description="Take an aerial tour of Cato Neimoidia's jewel city Tarko-Se in a small aircraft and watch the sunset for a beautiful and unforgettable view.", start_time='05:00 PM', end_time='07:00 PM', duration=2, planet_name="Cato Neimoidia")
...
f1 = Flight(flight_num=5700, depart_planet="Earth", arrive_planet="Coruscant", depart_time="07:00 AM", arrive_time="07:00 PM", flight_time=12)
f2 = Flight(flight_num=5701, depart_planet="Coruscant", arrive_planet="Earth", depart_time="08:00 PM", arrive_time="08:00 AM", flight_time=12)
f3 = Flight(flight_num=5710, depart_planet="Earth", arrive_planet="Endor", depart_time="08:00 AM", arrive_time="09:00 PM", flight_time=13)
f4 = Flight(flight_num=5711, depart_planet="Endor", arrive_planet="Earth", depart_time="10:00 PM", arrive_time="11:00 AM", flight_time=13)
f5 = Flight(flight_num=5720, depart_planet="Earth", arrive_planet="Mygeeto", depart_time="12:00 PM", arrive_time="02:00 AM", flight_time=14)
f6 = Flight(flight_num=5721, depart_planet="Mygeeto", arrive_planet="Earth", depart_time="03:00 AM", arrive_time="05:00 PM", flight_time=14)
f7 = Flight(flight_num=5730, depart_planet="Earth", arrive_planet="Bespin", depart_time="11:00 AM", arrive_time="03:00 AM", flight_time=16)
f8 = Flight(flight_num=5731, depart_planet="Bespin", arrive_planet="Earth", depart_time="04:00 AM", arrive_time="08:00 PM", flight_time=16)
f9 = Flight(flight_num=5740, depart_planet="Earth", arrive_planet="Hoth", depart_time="02:45 PM", arrive_time="06:45 AM", flight_time=16)
f10 = Flight(flight_num=5741, depart_planet="Hoth", arrive_planet="Earth", depart_time="07:45 AM", arrive_time="11:45 PM", flight_time=16)
f11 = Flight(flight_num=5750, depart_planet="Earth", arrive_planet="Polis Massa", depart_time="04:00 PM", arrive_time="09:00 AM", flight_time=17)
f12 = Flight(flight_num=5751, depart_planet="Polis Massa", arrive_planet="Earth", depart_time="10:00 AM", arrive_time="03:00 AM", flight_time=17)
f13 = Flight(flight_num=5760, depart_planet="Earth", arrive_planet="Mustafar", depart_time="05:30 PM", arrive_time="11:30 AM", flight_time=18)
f14 = Flight(flight_num=5761, depart_planet="Mustafar", arrive_planet="Earth", depart_time="12:30 PM", arrive_time="06:30 AM", flight_time=18)
f15 = Flight(flight_num=5770, depart_planet="Earth", arrive_planet="Dagobah", depart_time="02:45 PM", arrive_time="09:45 AM", flight_time=19)
f16 = Flight(flight_num=5771, depart_planet="Dagobah", arrive_planet="Earth", depart_time="10:45 AM", arrive_time="05:45 AM", flight_time=19)
f17 = Flight(flight_num=5780, depart_planet="Earth", arrive_planet="Utapau", depart_time="06:30 PM", arrive_time="02:30 PM", flight_time=20)
f18 = Flight(flight_num=5781, depart_planet="Utapau", arrive_planet="Earth", depart_time="03:30 PM", arrive_time="11:30 AM", flight_time=20)
f19 = Flight(flight_num=5790, depart_planet="Earth", arrive_planet="Kashyyyk", depart_time="01:45 PM", arrive_time="06:45 AM", flight_time=17)
f20 = Flight(flight_num=5791, depart_planet="Kashyyyk", arrive_planet="Earth", depart_time="07:45 AM", arrive_time="12:45 AM", flight_time=17)
f21 = Flight(flight_num=5800, depart_planet="Earth", arrive_planet="Yavin IV", depart_time="03:00 PM", arrive_time="10:00 AM", flight_time=19)
f22 = Flight(flight_num=5801, depart_planet="Yavin IV", arrive_planet="Earth", depart_time="11:00 AM", arrive_time="06:00 AM", flight_time=19)
f23 = Flight(flight_num=5810, depart_planet="Earth", arrive_planet="Naboo", depart_time="09:00 AM", arrive_time="06:00 AM", flight_time=21)
f24 = Flight(flight_num=5811, depart_planet="Naboo", arrive_planet="Earth", depart_time="07:00 AM", arrive_time="04:00 AM", flight_time=21)
f25 = Flight(flight_num=5820, depart_planet="Earth", arrive_planet="Tatooine", depart_time="08:00 AM", arrive_time="08:00 AM", flight_time=24)
f26 = Flight(flight_num=5821, depart_planet="Tatooine", arrive_planet="Earth", depart_time="09:00 AM", arrive_time="09:00 AM", flight_time=24)
f27 = Flight(flight_num=5830, depart_planet="Earth", arrive_planet="Geonosis", depart_time="12:45 PM", arrive_time="12:45 PM", flight_time=24)
f28 = Flight(flight_num=5831, depart_planet="Geonosis", arrive_planet="Earth", depart_time="01:45 PM", arrive_time="01:45 PM", flight_time=24)
f29 = Flight(flight_num=5840, depart_planet="Earth", arrive_planet="Felucia", depart_time="07:50 AM", arrive_time="07:50 AM", flight_time=24)
f30 = Flight(flight_num=5841, depart_planet="Felucia", arrive_planet="Earth", depart_time="08:50 AM", arrive_time="08:50 AM", flight_time=24)
f31 = Flight(flight_num=5850, depart_planet="Earth", arrive_planet="Cato Neimoidia", depart_time="10:50 AM", arrive_time="01:50 AM", flight_time=15)
f32 = Flight(flight_num=5851, depart_planet="Cato Neimoidia", arrive_planet="Earth", depart_time="02:50 AM", arrive_time="05:50 PM", flight_time=15)
f33 = Flight(flight_num=5860, depart_planet="Earth", arrive_planet="Kamino", depart_time="06:00 AM", arrive_time="07:00 AM", flight_time=25)
