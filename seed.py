...
resp_dicts[4]['description'] = "Bespin's Cloud City is a sight to behold.  A spectacle of intelligent engineering, the entire city sits above the crushing pressure of Bespin, giving you a safe and spectacular view of the beautiful skies.  Known for its opulent dining, hotels, and night life, there are no shortage of things to do.  You can also visit the famous carbon-freezing facility where Rebel hero Han Solo was frozen in carbonite and where Lord Vader told Luke Skywalker that he was his father.  Such history here in Bespin!"
resp_dicts[5]['description'] = "Made famous from the Battle of Endor, where the Rebel Alliance defeated the dreaded Empire for good and destroyed the second Death Star, the forest moon of Endor is rich with history and natural beauty.  You can visit a part original/part recreation of the Empire bunker and base, you can spend a few nights in a beautiful Ewok village, or you can explore the beautiful forests on a speeder bike.  No shortage of things to do here on Endor!"
...
pi10 = PlanetImage(image_name="Hoth_Echo_Base.jpg", planet_name="Hoth")
...
pi22 = PlanetImage(image_name="Endor_bunker.jpg", planet_name="Endor")
...
ti12 = TourImage(image_name="Hoth_Echo_Base.jpg", tour_id=7)
...
ti21 = TourImage(image_name="Endor_bunker.jpg", tour_id=12)
